...
cap = cv2.VideoCapture('C:\\Users\\ASUS\\OneDrive\\Desktop\\Sparks Foundation\\social distance detector\\Social-Distancing-Detector-master\\videos\\test_video_2.mp4')
...
while cv2.waitKey(100) < 0:
    ...
    ret,image=cap.read()
    image=cv2.resize(image,(940,560))
    (H, W) = image.shape[:2]
    ...
    print("Frame Prediction Time : {:10.2f} seconds".format(end - start))
    boxes = []
    confidences = []
    classIDs = []
